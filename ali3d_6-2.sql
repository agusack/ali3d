...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 07-02-2024 a las 00:50:02
...
(1, 'admin', 'admin@admin.com', '$2y$10$AzrojvHL.huTqcaqP1IoTevFKy9tqM8Se3MBBdf9FlZpneimoFlzW', 1);
...
ALTER TABLE `productos_tags`
  ADD PRIMARY KEY (`id_producto`,`id_tag`),
...
--
ALTER TABLE `productos_tags`
  ADD CONSTRAINT `productos_tags_ibfk_1` FOREIGN KEY (`id_producto`) REFERENCES `productos` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `productos_tags_ibfk_2` FOREIGN KEY (`id_tag`) REFERENCES `tags` (`id_tag`) ON DELETE CASCADE;
