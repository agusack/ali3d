...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql = "INSERT INTO categorias_papel (nombre_cat_papel) VALUES ('$nombre_categoria')";
...
<html>
<head>
    <title>Añadir categoria papel - Tienda Online</title>
...
<body>
    ...
    <!-- Formulario para agregar categorías -->
            <h2>Añadir Categoría papelería</h2>
            <form action="añadir_cat_papel.php" method="POST">
