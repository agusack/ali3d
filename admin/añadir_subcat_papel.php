...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql = "INSERT INTO subcategorias_papel (nombre_subcat_papel, id_cat_papel) VALUES ('$nombre_subcategoria', '$id_categoria')";
...
<body>
    ...
    <!-- Formulario para agregar categorías -->
            ...
            <form action="añadir_subcat_papel.php" method="POST">
                ...
                <select name="id_categoria" id="categoria">
                    ...
                    <?php while($categoria = mysqli_fetch_array($categorias)) { ?>
                        <option value="<?php echo $categoria['id_cat_papel']; ?>"><?php echo $categoria['nombre_cat_papel']; ?></option>
                    <?php } ?>
                </select>
