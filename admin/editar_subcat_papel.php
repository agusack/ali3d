...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql = "UPDATE subcategorias_papel SET nombre_subcat_papel='$nombre_subcategoria', id_cat_papel='$id_categoria' WHERE id_subcat_papel=$id_subcategoria";
    ...
    $sql = "SELECT * FROM subcategorias_papel WHERE id_subcat_papel=$id_subcategoria";

    $resultado = mysqli_query($conexion, $sql);

    if ($fila = mysqli_fetch_array($resultado)) {
        $nombre_subcategoria = $fila['nombre_subcat_papel'];
        $id_categoria = $fila['id_cat_papel'];
    } else {
