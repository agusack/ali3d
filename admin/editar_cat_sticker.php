...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql = "UPDATE categorias_sticker SET nombre_cat_sticker='$nombre_categoria' WHERE id_cat_sticker=$id_categoria";
    ...
    $sql = "SELECT * FROM categorias_sticker WHERE id_cat_sticker=$id_categoria";

    $resultado = mysqli_query($conexion, $sql);

    if ($fila = mysqli_fetch_array($resultado)) {
        $nombre_categoria = $fila['nombre_cat_sticker'];
    } else {
...
<html>
<head>
    <title>Editar Categoría Sticker</title>
...
<body>
    <div id="wrapper">
            ...
            ?>
        <div id="main">
            <h1>Editar Categoría Sticker</h1>
