...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql = "UPDATE categorias_papel SET nombre_cat_papel='$nombre_categoria' WHERE id_cat_papel=$id_categoria";
    ...
    $sql = "SELECT * FROM categorias_papel WHERE id_cat_papel=$id_categoria";

    $resultado = mysqli_query($conexion, $sql);

    if ($fila = mysqli_fetch_array($resultado)) {
        $nombre_categoria = $fila['nombre_cat_papel'];
    } else {
...
<html>
<head>
    <title>Editar Categoría Papelería</title>
...
<body>
    <div id="wrapper">
            ...
            ?>
        <div id="main">
            <h1>Editar Categoría Papelería</h1>
