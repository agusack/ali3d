...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql = "INSERT INTO categorias_sticker (nombre_cat_sticker) VALUES ('$nombre_categoria')";
...
<html>
<head>
    <title>Añadir categoria sticker - Tienda Online</title>
...
<body>
    ...
    <!-- Formulario para agregar categorías -->
            <h2>Añadir Categoría Sticker</h2>
            <form action="añadir_cat_sticker.php" method="POST">
