...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql = "UPDATE subcategorias_sticker SET nombre_subcat_sticker='$nombre_subcategoria', id_cat_sticker='$id_categoria' WHERE id_subcat_sticker=$id_subcategoria";
    ...
    $sql = "SELECT * FROM subcategorias_sticker WHERE id_subcat_sticker=$id_subcategoria";

    $resultado = mysqli_query($conexion, $sql);

    if ($fila = mysqli_fetch_array($resultado)) {
        $nombre_subcategoria = $fila['nombre_subcat_sticker'];
        $id_categoria = $fila['id_cat_sticker'];
    } else {
